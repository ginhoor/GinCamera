...
//                                    self.markBtn,
    ...
    self.status = GinPhotoSingleCaptureStatusReady;
...
- (void)setStatus:(GinPhotoSingleCaptureStatus)status
{
    _status = status;
    
    switch (status) {
        case GinPhotoSingleCaptureStatusReady: {
...
//                    && ![self.viewModel.photoIndex hasTips] && ![self.viewModel.photoIndex.sampleUrl isNotBlank]
        ...
        case GinPhotoSingleCaptureStatusCaptured: {
        ...
        case GinPhotoSingleCaptureStatusMark: {
        ...
        case GinPhotoSingleCaptureStatusMosaics: {
...
{
    if (self.status != GinPhotoSingleCaptureStatusReady) {
        return;
    }
